...
role_arn="`aws iam get-role --role-name clearpass-driver-dev-us-west-2-lambdaRole --query Role.Arn --output text`"
constraints="EncryptionContextEquals={app=clearpass-driver}"
